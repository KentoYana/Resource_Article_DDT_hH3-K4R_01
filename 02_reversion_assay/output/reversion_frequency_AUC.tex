% Created by tikzDevice version 0.12.6 on 2026-09-24 00:41:50
% !TEX encoding = UTF-8 Unicode
\begin{tikzpicture}[x=1pt,y=1pt]
\definecolor{fillColor}{RGB}{255,255,255}
% Manually restored presentation crop after tikzDevice export.
\path[use as bounding box,fill=fillColor,fill opacity=0.00] (  0.00,115.13) rectangle (542.02,390.76);
\begin{scope}
...
\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  1.00] at ( 56.94,338.70) {p = 0.129};
...
\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  1.00] at (180.79,338.70) {p = 0.129};
\definecolor{drawColor}{gray}{0.20}
...
\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  1.00] at (304.64,338.70) {p = 0.00586};
\definecolor{drawColor}{gray}{0.20}
...
\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  1.00] at (428.49,338.70) {p = 0.0156};
\definecolor{drawColor}{gray}{0.20}
...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.80] at (167.98,375.47) {Base substitution reversion frequency using \textit{pan-2}(B36)};
\end{scope}
\begin{scope}
...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.80] at (415.68,375.47) {Frameshift reversion frequency using \textit{pan-2}(OGW1)};
\end{scope}
\begin{scope}
...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.80] at (106.05,360.41) {Panel \#1: \textit{hH3-K4R}};
\end{scope}
\begin{scope}
...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.80] at (229.90,360.41) {Panel \#2: \textit{$\Delta$set-1}};
\end{scope}
\begin{scope}
...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.80] at (353.75,360.41) {Panel \#3: \textit{hH3-K4R}};
\end{scope}
\begin{scope}
...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.80] at (477.60,360.41) {Panel \#4: \textit{$\Delta$set-1}};
\end{scope}
\begin{scope}
...
\node[text=drawColor,rotate= 90.00,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.00] at ( 22.69,259.48) {at the \textit{pan-2} locus (\textit{pan}$^{+}$ / $10^{7}$ survivors)};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (542.02,505.89);
\definecolor{fillColor}{RGB}{255,255,255}
...
\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.80] at (285.48,126.64) {\textit{hH3-K4R}};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (542.02,505.89);
\definecolor{drawColor}{RGB}{0,0,0}

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.80] at (343.15,126.64) {\textit{$\Delta$set-1}};
\end{scope}
\end{tikzpicture}
