...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.80] at (229.90,360.41) {\textit{set-1} KO};
\end{scope}
\begin{scope}
...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.80] at (477.60,360.41) {\textit{set-1} KO};
\end{scope}
\begin{scope}
...
\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.80] at (343.15,126.64) {\textit{set-1} KO};
\end{scope}
\end{tikzpicture}
